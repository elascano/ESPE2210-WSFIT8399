...
function validateBrand() {
  ...
  if (inp.trim() === '') {
    brandError.innerText = "Enter the brand.";
    brandError.style.display = 'block';
    return false;
  } else if (!brandRegex.test(inp)) {
    brandError.innerText = "Enter valid brand.";
    brandError.style.display = 'block';
    return false;
  } else {
...
function validatePlate() {
  ...
  if (inp.trim() === '') {
    plateError.innerText = "Enter the plate.";
    plateError.style.display = 'block';
    return false;
  } else if (!plateRegex.test(inp)) {
    plateError.innerText = "Enter the valid plate.";
    plateError.style.display = 'block';
    return false;
  } else {
...
function validateModel() {
  ...
  if (inp.trim() === '') {
    modelError.innerText = "Enter the model.";
    modelError.style.display = 'block';
    return false;
  } else if (!modelRegex.test(inp)) {
    modelError.innerText = "Enter the valid model.";
    modelError.style.display = 'block';
    return false;
  } else {
