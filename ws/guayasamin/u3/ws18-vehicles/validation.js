...
function validateBrand() {
    ...
    if (inp.trim() === '') {
      brandError.innerText = "Write the brand of vehicle";
      brandError.style.display = 'block';
      return false;
    } else if (!brandRegex.test(inp)) {
      brandError.innerText = "The brand entered is not valid";
      brandError.style.display = 'block';
      return false;
    } else {
...
function validatePlate() {
    ...
    if (inp.trim() === '') {
      plateError.innerText = "Write de plate of the vehicle";
      plateError.style.display = 'block';
      return false;
    } else if (!plateRegex.test(inp)) {
      plateError.innerText = "The plate is not valid";
      plateError.style.display = 'block';
      return false;
    } else {
  ...
  function validateModel() {
    ...
    if (inp.trim() === '') {
      modelError.innerText = "Write the model";
      modelError.style.display = 'block';
      return false;
    } else if (!modelRegex.test(inp)) {
      modelError.innerText = "The model is invalid";
      modelError.style.display = 'block';
      return false;
    } else {
